...
Within NGA there is a specific convention for moving within a cell to various subcells. This convention is illustrated in Figure~\ref{fig:fg}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.5\textwidth]{figs/finegrid.png}
	\caption{finegrid representation}
	\label{fig:fg} 
\end{figure} 
